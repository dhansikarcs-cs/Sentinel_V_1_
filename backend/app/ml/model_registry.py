...
class ModelMetadata:
    def __init__(self, name: str, version: str, model_type: str, path: str,
                 trained_at: str = "", metrics: dict = None, description: str = ""):
        self.name = name
...
class ModelRegistry:
    ...
    def register(self, name: str, version: str, model_type: str, path: str,
                 trained_at: str = "", metrics: dict = None, description: str = "") -> dict:
        key = f"{name}:{version}"
