    ...
    <div className="min-h-screen flex items-center justify-center" style={{ padding: '32px' }}>
      <div style={{ width: '100%', maxWidth: '560px' }}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <div style={{ color: '#6a6474', fontSize: '0.85rem', marginTop: '4px' }}>Let's get you set up in a few quick steps</div>
        </div>
        ...
        {/* Progress bar */}
        <div style={{ height: '3px', background: '#1e2336', borderRadius: '2px', marginBottom: '20px', overflow: 'hidden' }}>
          <div style={{ height: '100%', width: `${((step + 1) / 4) * 100}%`, background: 'linear-gradient(90deg, #22c55e, #c49ea4)', borderRadius: '2px', transition: 'width 0.4s ease' }} />
        </div>
        ...
        <div className="card" style={{ padding: '28px', minHeight: '280px' }}>
          ...
          {step === 0 && (
            <div>
              ...
              <div style={{ background: 'linear-gradient(135deg,#1e2336,#1e2a45)', border: '1px solid #2d2d44', borderRadius: '12px', padding: '20px', margin: '12px 0' }}>
                <div style={{ color: '#6a6474', fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Your Account</div>
                <div style={{ color: '#e0e8f0', fontSize: '1.1rem', fontWeight: 600, marginTop: '4px' }}>{user?.name || user?.username}</div>
                <div style={{ color: '#6a6474', fontSize: '0.75rem', marginTop: '8px', lineHeight: 1.5 }}>
          ...
          {step === 1 && (
            <div>
              ...
              <div style={{ marginTop: '8px' }}>
                <button onClick={() => goTo(0)} style={{ background: 'none', border: 'none', color: '#6a6474', cursor: 'pointer', fontSize: '0.75rem' }}>← Back</button>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div>
              ...
              <div style={{ marginTop: '8px' }}>
                <button onClick={() => goTo(1)} style={{ background: 'none', border: 'none', color: '#6a6474', cursor: 'pointer', fontSize: '0.75rem' }}>← Back</button>
              </div>
            </div>
          )}
          ...
          {step === 3 && (
            <div>
              ...
              <div style={{ marginTop: '8px' }}>
                <button onClick={() => goTo(2)} style={{ background: 'none', border: 'none', color: '#6a6474', cursor: 'pointer', fontSize: '0.75rem' }}>← Back</button>
              </div>
            </div>
          )}
          ...
          {step >= 4 && (
            <div style={{ background: 'linear-gradient(135deg,#1a1e30,#1a3a2a)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: '16px', padding: '32px', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', marginTop: '20px' }}>
                <button onClick={() => goTo(3)} style={{ flex: 1, padding: '10px', background: '#1e2336', border: '1px solid #2d2d44', borderRadius: '8px', color: '#6a6474', cursor: 'pointer' }}>← Back</button>
        ...
        {/* Bottom nav hint */}
        <div style={{ textAlign: 'center', marginTop: '12px', color: '#5a4a5a', fontSize: '0.7rem' }}>
