...
BORDER_DEFAULT = "1px solid #28324c"
BORDER_ACCENT = "1px solid #2f3a56"
...
BORDER_DANGER = lambda c: f"border:1px solid {c};border-radius:10px;padding:14px;margin-bottom:10px;background:#191f30;"

ACCENT_LABELS = {
    "status": {"Accepted": "#22c55e", "Declined": "#ef4444", "Waitlisted": "#f59e0b", "Pending": "#5b9cf5"},
...
<style>
    ...
    * { font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; }
    ...
    .stApp {
        background: linear-gradient(160deg, #171c2a 0%, #1b2132 40%, #161b28 100%);
    }
    .main > div { padding: 1.5rem 2rem; }

    ::selection { background: #5b9cf5; color: white; }
    ::-webkit-scrollbar { width: 5px; }
    ::-webkit-scrollbar-track { background: #171c2a; }
    ::-webkit-scrollbar-thumb { background: #2f3a56; border-radius: 4px; }
    ::-webkit-scrollbar-thumb:hover { background: #42507a; }
    ...
    hr { margin: 1.25rem 0 !important; border-color: #28324c !important; opacity: 0.4; }

    .st-bw, .st-bv, .st-cx, .st-cy { color: #d4dae8 !important; }
    ...
    button, .stButton > button {
        ...
        border: 1px solid #34406a !important;
    ...
    button:hover, .stButton > button:hover {
        ...
        box-shadow: 0 4px 16px rgba(91,156,245,0.12);
    }
    button:active { transform: translateY(0); }
    button[kind="primary"], .stButton > button[kind="primary"] {
        background: linear-gradient(135deg, #5b9cf5, #4a8ae8) !important;
        border: none !important;
        color: white !important;
        box-shadow: 0 2px 8px rgba(91,156,245,0.2);
    }
    button[kind="primary"]:hover {
        background: linear-gradient(135deg, #7bb4ff, #5b9cf5) !important;
        box-shadow: 0 4px 16px rgba(91,156,245,0.3);
    }

    .stTextInput > div > div > input, .stTextArea textarea {
        background: #1e253a !important;
        border: 1px solid #28324c !important;
        color: #e8ecf4 !important;
        caret-color: #5b9cf5 !important;
        border-radius: 8px;
    ...
    .stTextInput > div > div > input:-webkit-autofill {
        -webkit-text-fill-color: #e8ecf4 !important;
        -webkit-box-shadow: 0 0 0 30px #1e253a inset !important;
    }
    input[type="password"] { color: #e8ecf4 !important; }
    ...
    .stNumberInput > div > div:focus-within, .stDateInput > div > div:focus-within, .stTimeInput > div > div:focus-within, .stSelectbox > div > div:focus-within {
        border-color: #5b9cf5 !important;
        box-shadow: 0 0 0 3px rgba(91,156,245,0.08) !important;
    }
    ...
    div[data-baseweb="select"] > div:hover { border-color: #5b9cf5 !important; }
    ...
    .stSelectbox svg, .stDateInput svg, .stTimeInput svg { fill: #8896ae !important; }
    ...
    .stMetric {
        background: rgba(30,37,58,0.5);
        border-radius: 10px;
        padding: 12px !important;
        border: 1px solid #28324c;
        transition: border-color 0.2s;
    }
    .stMetric:hover { border-color: #34406a; }
    .stMetric label, .stMetric div { color: #a8b4cc !important; }
    ...
    div[data-testid="stExpander"]:hover { border-color: #34406a; }
    div[data-testid="stExpander"] > div[role="button"] p { font-size: 0.875rem; }
    div[data-testid="stExpander"] div[role="button"] p { color: #d4dae8 !important; }
    ...
    .st-bw, .st-bv { background-color: #1e253a; }
    ...
    div[data-testid="stDataFrame"] tr:nth-child(even) td { background: #171c2a !important; }

    .stToggle label { color: #a8b4cc !important; }
    .stCheckbox label { color: #a8b4cc !important; }

    .psych-box {
        background: linear-gradient(135deg, rgba(91,156,245,0.06), rgba(74,138,232,0.03));
    ...
    section[data-testid="stSidebar"] {
        ...
        border-right: 1px solid #28324c !important;
    }
    ...
    section[data-testid="stSidebar"] .stMetric {
        background: rgba(30,37,58,0.5) !important;
    ...
    section[data-testid="stSidebar"] .stCaption { color: #8896ae !important; }
    section[data-testid="stSidebar"] .st-bb { background-color: transparent !important; }
    section[data-testid="stSidebar"] hr {
        border-color: #28324c !important;
    ...
    .stSpinner > div { border-color: #5b9cf5 !important; }
    ...
    .journal-card {
        background: linear-gradient(135deg, #1e253a, #1b2132);
        border: 1px solid #2f3a56;
        border-radius: 10px;
        padding: 16px;
        transition: border-color 0.2s, box-shadow 0.2s;
    }
    .journal-card:hover { border-color: #34406a; box-shadow: 0 2px 12px rgba(91,156,245,0.06); }

    .step-done { background: #1a3a2a; border-color: #22c55e40; }
    .step-active { background: #1a2a4a; border-color: #5b9cf560; }
    .step-pending { background: #1e253a; border-color: #28324c; }
